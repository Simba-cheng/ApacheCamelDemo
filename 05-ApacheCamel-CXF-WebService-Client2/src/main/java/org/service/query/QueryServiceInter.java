...
public interface QueryServiceInter {
    ...
    public java.lang.String queryCarInfomation(
        @WebParam(name = "carParam", targetNamespace = "")
        java.lang.String carParam
    );
    ...
    public java.lang.String queryPersonnelInformation(
        @WebParam(name = "peopleParam", targetNamespace = "")
        java.lang.String peopleParam
    );
}
